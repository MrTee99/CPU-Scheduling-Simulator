...
public class PfcfsEnterProcess {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PfcfsEnterProcess window = new PfcfsEnterProcess();
	...
	private void initialize() {
		...
		JLabel lblNonpreemptiveFcfsScheduling = new JLabel("Preemptive FCFS Scheduling");
