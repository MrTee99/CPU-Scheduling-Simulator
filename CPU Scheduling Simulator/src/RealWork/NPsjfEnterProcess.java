...
public class NPsjfEnterProcess {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NPsjfEnterProcess window = new NPsjfEnterProcess();
	...
	private void initialize() {
		...
		JLabel lblNonpreemptiveFcfsScheduling = new JLabel("Non-Preemptive SJF Scheduling");
