...
public class NPfcfsEnterProcess {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NPfcfsEnterProcess window = new NPfcfsEnterProcess();
	...
	private void initialize() {
		...
		JLabel lblNonpreemptiveFcfsScheduling = new JLabel("Non-Preemptive FCFS Scheduling");
