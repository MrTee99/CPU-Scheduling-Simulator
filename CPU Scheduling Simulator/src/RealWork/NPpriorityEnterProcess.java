...
public class NPpriorityEnterProcess {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NPpriorityEnterProcess window = new NPpriorityEnterProcess();
	...
	private void initialize() {
		...
		JLabel lblNonpreemptiveFcfsScheduling = new JLabel("Non-Preemptive Priority Scheduling");
		...
		btnEnter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (totalP > 0  && totalP <= 10) {
					NPpriority a = new NPpriority(totalP);
					frmEnterProcess.setVisible(false);
				}
				else {
