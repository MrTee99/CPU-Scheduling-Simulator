...
public class PsjfEnterProcess {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PsjfEnterProcess window = new PsjfEnterProcess();
	...
	private void initialize() {
		...
		JLabel lblNonpreemptiveFcfsScheduling = new JLabel("Preemptive SJF Scheduling");
